...
export default function TopMenu() {
  return (
    ...
    <section className="w-full h-full flex justify-center items-center mb-5 px-3">
      <div className="max-w-5xl w-full h-[50vh] flex flex-col justify-end items-center bg-bgFastingImage bg-cover bg-top bg-no-repeat border rounded-[16px]">
        <div className="flex flex-col justify-end gap-5 mb-10 ml-10">
          ...
          <div className="flex flex-row gap-5">
            {/* <Link href="https://pushpay.com/g/vinechurchfl?src=hpp">
              <button className="sm:w-52 w-20 sm:h-10 h-7 sm:text-lg text-sm uppercase border rounded-md bg-[var(--gold)]">
                Give
              </button>
            </Link> */}
            {/* <Link href="/fast">
              <button className="sm:w-52 w-36 sm:h-10 h-7 sm:text-lg text-sm text-black uppercase sm:border border-none border-cyan-500 rounded-md bg-[var(--gold)] hover:text-[var(--gold)] hover:bg-white">
                Fasting
              </button>
            </Link> */}
          </div>
