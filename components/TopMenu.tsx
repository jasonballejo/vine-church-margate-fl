...
export default function TopMenu() {
  return (
    ...
    <section className="w-full h-full flex justify-center items-center mb-5">
      <div className="max-w-5xl w-full h-[40vh] flex flex-col justify-end items-center bg-bgTopMenu bg-cover bg-bottom bg-no-repeat border rounded-[16px]">
        ...
        {/* <div className="max-w-5xl w-full flex flex-col justify-end items-center text-white gap-5">
          <Image
            ...
            height={550}
          />
          <div className="flex flex-col justify-end gap-5 sm:mb-20 mb-0 sm:mt-0 mt-[360px] ml-10">
            <div className="flex flex-col gap-1">
              <h2 className="sm:text-4xl text-xl font-bold uppercase z-0">
                Welcome <span className="font-extralight">home</span>
              </h2>
              <p className="sm:w-[70%] w-full sm:text-md text-xs font-extralight tracking-widest z-0">
                Our burden is to edify a church of overcomers where every member
                is a minister and every house an extension of the Church thereby
                conquering our generations to Christ through life-groups that
                multiply.
